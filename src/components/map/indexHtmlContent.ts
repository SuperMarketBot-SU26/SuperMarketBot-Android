...
<body>
  ...
  <script>
    ...
    const OBSTACLE_BOXES = [
      { minX: 1.9, maxX: 2.5, minZ: 2.65, maxZ: 2.95 },  // Zone 1: Shelf 1A
      { minX: 2.65, maxX: 2.95, minZ: 1.3, maxZ: 2.1 },   // Zone 1: Shelf 1B
      { minX: 0.5, maxX: 1.1, minZ: 2.65, maxZ: 2.95 },   // Zone 2: Shelf 2A
      { minX: 0.05, maxX: 0.35, minZ: 1.9, maxZ: 2.5 },   // Zone 2: Shelf 2B
      { minX: 0.05, maxX: 0.35, minZ: 0.25, maxZ: 0.95 }, // Zone 3: Shelf 3A
      { minX: 0.55, maxX: 0.85, minZ: 0.25, maxZ: 0.95 }, // Zone 3: Shelf 3B
      { minX: 1.3, maxX: 1.7, minZ: 1.2, maxZ: 1.8 },     // Zone 4: Shelf 4 Center Island
      { minX: 1.2, maxX: 1.6, minZ: 0.1, maxZ: 0.5 },     // Obstacle Zone [ X ]
      { minX: 2.0, maxX: 2.6, minZ: 0.1, maxZ: 0.5 }      // Cashier Desk (Thu Ngân)
    ];
