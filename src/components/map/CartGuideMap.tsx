...
// Khung tá»a Ä‘á»™ cá»§a 4 waypoint Ä‘Ã£ Ä‘o trÃªn active SLAM map.
// CÃ³ thá»ƒ hiá»‡u chá»‰nh khi thay map mÃ  khÃ´ng pháº£i sá»­a component.
...
export default function CartGuideMap({ destinations, currentWaypointIndex, robotPose }: CartGuideMapProps) {
  ...
  const projection = (point: Point) => {
    ...
    return {
      // Waypoint lÃ  tá»a Ä‘á»™ ROS (Y hÆ°á»›ng lÃªn), cÃ²n sÆ¡ Ä‘á»“ kiosk cÃ³ Y hÆ°á»›ng xuá»‘ng.
      // Auto-fit giá»¯ nguyÃªn hÃ¬nh há»c tÆ°Æ¡ng Ä‘á»‘i cá»§a tuyáº¿n, khÃ´ng thay Ä‘á»•i dá»¯ liá»‡u tháº­t.
